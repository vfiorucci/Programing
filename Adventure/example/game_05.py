...
def start_adventure():
    ...
    '''
    print('You enter a room, and you see a ' + colored('red door', 'red') + ' to your left and a ' + colored('blue door', 'blue') + ' to your right.')
    door_picked = input('Do you pick the ' + colored('red door', 'red') + ' or ' + colored('blue door', 'blue') + '? > ')
